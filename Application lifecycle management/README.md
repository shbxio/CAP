# In this documentation you will learn how to upload our demo to your Power Apps environment using a PowerShell script <br /> **`Organizational profile`**  (Estimated duration of completion: 75 Minutes)
